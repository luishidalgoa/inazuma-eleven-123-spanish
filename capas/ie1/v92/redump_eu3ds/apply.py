...
Si work/ie1/capas/v91/nombres_oficiales/events{,_mch}/<eid>.ssd existe, se parte de ese evento (v91 no
...
Uso: python -X utf8 work/ie1/capas/v92/redump_eu3ds/apply.py
"""
...
V91 = C.ROOT / 'work/ie1/capas/v91/nombres_oficiales'
...
def main():
    ...
    informe['objetivos'] = dict(registro_bigramas='work/ie1/capas/v89/bigramas_ritmo/registro.json',
