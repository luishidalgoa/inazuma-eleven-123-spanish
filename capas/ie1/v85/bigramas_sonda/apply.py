...
informe.json.
Uso: python -X utf8 work/ie1/capas/v85/bigramas_sonda/apply.py [--base .../probe_ie1_v84/archive.fa]
"""
...
V79 = _modulo('v79_rotulos', ROOT / 'work/ie1/capas/v79/rotulos/apply.py')
V75G = _modulo('v75_glifos_eu', ROOT / 'work/ie1/capas/v75/glifos_eu/apply.py')
...
CELDA = 15
TINTA_MAX = 14
HUECOS = ROOT / 'work/ie1/capas/v83/bigramas/huecos.json'
...
def main():
    ...
    v75 = (ROOT / 'work/ie1/capas/v75/glifos_eu/extra' / F12).read_bytes()
