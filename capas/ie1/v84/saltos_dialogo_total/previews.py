...
CASOS = [(81000090, 406), (92040100, 15), (81000090, 540), (92050600, 82), (10100003, 43), (10020017, 36), (92100950, 0), (97000013, 95)]
...
def main():
    ...
    v81, v82 = K.Archivo(C / 'probe_ie1_v81/archive.fa'), K.Archivo(C / 'probe_ie1_v84/archive.fa')
    f = v82.fuente()
    ...
    for eid, idx in CASOS:
        cols = [('v20 (antes del piloto)', encode_fullwidth(ap[(eid, idx)]['v20'])),
                ...
                ('v84 (22 caracteres, total)', K.S.parse(v82.evento(eid))[2][idx].body)]
