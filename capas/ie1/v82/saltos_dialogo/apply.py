"""v82 · saltos de diálogo: piloto CORREGIDO con el límite real del motor (22 caracteres, 3 líneas).
...
def main():
    ...
    args = ap.parse_args()
    if args.todos and not args.analizar:
        ap.error('--todos solo en modo --analizar')
