...
Registro: el de v89 (work/ie1/capas/v89/bigramas_ritmo/registro.json) + pares añadidos al final con códigos
...
ROOT = HERE.parents[4]
W = ROOT / 'work'
for p in (HERE, W / 'ie1/capas/v88/bigramas_total', W / 'ie2/shared/capas/v03/textos/cro', ROOT / 'tools/src',
          ROOT / 'tools'):
...
REG89 = W / 'ie1/capas/v89/bigramas_ritmo/registro.json'
...
class Tipografia:
    ...
    def registro_json(self, añadidos, fuentes_sha):
        r = dict(self.reg89)
        r['version'] = 'v90'
        r['descripcion'] = (self.reg89['descripcion'] + ' v90 (work/ie1/capas/v90/cro_restantes): literales del '
