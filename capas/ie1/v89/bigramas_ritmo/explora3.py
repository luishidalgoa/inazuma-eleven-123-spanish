...
sys.path.insert(0, str(Path(__file__).parent)); sys.path.insert(1, r'C:\Users\luish\Projects\inazuma-eleven-123-spanish\work\ie1\capas\v88\bigramas_total')
import comun88, ritmo as R
A = comun88.modulo('v88_bigramas', Path(r'C:\Users\luish\Projects\inazuma-eleven-123-spanish\work\ie1\capas\v88\bigramas_total\apply.py'))
