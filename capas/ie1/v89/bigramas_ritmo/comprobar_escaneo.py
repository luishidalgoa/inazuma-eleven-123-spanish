"""v89 · comprueba escaneo_v89.json (escaneo estricto de los códigos del registro sobre probe_ie1_v88):
...
esc = json.loads((HERE / 'escaneo_v89.json').read_text(encoding='utf-8'))
...
val['escaneo_kanji_v89'] = dict(codigos=len(reg['bigramas']), ficheros_con_codigos=sorted(
...
print(val['escaneo_kanji_v89']['resultado'], len(errores), errores[:10], val['escaneo_kanji_v89']['ficheros_con_codigos'])
