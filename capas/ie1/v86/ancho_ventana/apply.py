...
Uso: python -X utf8 work/ie1/capas/v86/ancho_ventana/apply.py
"""
...
sys.path.insert(0, str(HERE.parents[1] / 'v84/saltos_dialogo_total'))
...
# Texto de los registros: dato local (no se publica), en work/ie1/capas/v86/ancho_ventana/cambios.json
# formato {"id": [linea1, linea2, intacto]}.
CAMBIOS = {int(k): tuple(v) for k, v in json.loads(
    (K.ROOT / 'work/ie1/capas/v86/ancho_ventana/cambios.json').read_text('utf-8')).items()}
