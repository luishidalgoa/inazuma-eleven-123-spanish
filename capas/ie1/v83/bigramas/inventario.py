...
Uso: python -X utf8 work/ie1/capas/v83/bigramas/inventario.py -> inventario.json
"""
...
ROOT = HERE.parents[4]
_spec = importlib.util.spec_from_file_location('v76', ROOT / 'work/ie1/capas/v76/rotulos_largos/apply.py')
...
def textos():
    ...
    prop = (ROOT / 'work/ie1/capas/v76/rotulos_largos/propuesta.md').read_text(encoding='utf-8')
