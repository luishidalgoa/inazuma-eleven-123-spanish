...
Base analizada: `work/shared/candidatas/probe_ie1_v81/archive.fa`. La fuente es `font/FONT12.bcfnt`, que es la misma que `work/ie1/capas/v75/glifos_eu/extra/font/FONT12.bcfnt` (mismo SHA-1). El código se ha leído de `ina_main1.cro` (original) y de `exefs/code.bin` (descomprimido con BLZ).
