...
Salida: validacion.json.  Uso: python -X utf8 work/ie1/capas/historial/fuentes/v85_bigramas_sonda/validar.py
"""
...
def main():
    ...
    for e in reg['bigramas']:
        gi = e['glifo']
        px, ancho, D, R = A.Glifos(A.cargar(ROOT / 'work/ie1/capas/fuentes/glifos_eu/extra' / A.F12)).par(*e['par'])
