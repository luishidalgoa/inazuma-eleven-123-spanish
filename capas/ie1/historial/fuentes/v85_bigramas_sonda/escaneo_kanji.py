"""v85 · sonda de bigramas: comprobación estricta de que ciertos códigos Shift-JIS no aparecen en ningún texto.

Complementa work/ie1/capas/historial/fuentes/v83_bigramas/escaneo_sjis.py (que solo contaba rachas de >= 2 caracteres de
...
ROOT = HERE.parents[5]
V83 = ROOT / 'work/ie1/capas/historial/fuentes/v83_bigramas'
