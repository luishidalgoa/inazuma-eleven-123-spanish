"""v08 · literales en code.bin y CRO (copia de work/ie1/capas/v89/bigramas_ritmo/escaneo_literales.py con las
...
sys.path.insert(0, str(ROOT / 'work/ie1/capas/v89/bigramas_ritmo'))
