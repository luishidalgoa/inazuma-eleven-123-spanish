...
sys.path.insert(0, r'C:/Users/luish/Projects/inazuma-eleven-123-spanish/work/ie1/capas/v37/graficos_nds')
from PIL import ImageDraw, Image
import base as B
import piezas_nds as PN
C = B.C
PN.NDS = B.HERE.parents[4] / 'ie2' / 'tormenta_de_fuego' / 'fuentes' / 'nds_es' / 'data_iz'
ims = []
