...
ROOT = HERE.parents[5]
W = ROOT / 'work'
for p in (W / 'ie2/shared/capas/v03/textos', ROOT / 'tools/src', ROOT / 'tools'):
...
SALIDA_FUEGO = W / 'ie2/tormenta_de_fuego/capas/v07/media'  # solo Fuego
...
REG90 = W / 'ie1/capas/v90/cro_restantes/registro.json'
...
class Tipo:
    ...
    def asignar_y_dibujar(self):
        ...
        self.reg['descripcion'] = (self.reg['descripcion'] + ' IE2 v07 (work/ie2/shared/capas/v07/media): casillas '
