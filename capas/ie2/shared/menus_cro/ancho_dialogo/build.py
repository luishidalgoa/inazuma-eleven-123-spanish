"""IE2 v15 · candidata probe_ie2_v15 = probe_ie2_v10 + eventos IE2 de esta capa + ina_main2.cro parcheada.
...
Uso: python -X utf8 work/ie2/shared/capas/menus_cro/ancho_dialogo/build.py
"""
...
BASE = V10 / 'archive.fa'
SALIDA_DIR = W / 'shared/candidatas/probe_ie2_v15'
...
def main():
    ...
    tmp = Path(tempfile.mkdtemp(prefix='ie2_v15_'))
    try:
