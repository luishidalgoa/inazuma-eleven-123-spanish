"""IE2 v14 · validación de la sonda de ancho (capa y, si existe, la candidata probe_ie2_v14).
...
Uso: python -X utf8 work/ie2/shared/capas/historial/menus_cro/v14_ancho_dialogo/validate.py  -> validacion.json
"""
...
def main():
    ...
    for a, w0, w1, _ in A.PARCHES:
        ...
        ok(f'cro_{a:#x}', A.u32(base, a) == w0 and A.u32(nueva, a) == w1 and dis[0].endswith('#0x1a0'), dis)
    ...
    # candidata
    cand = A.W / 'shared/candidatas/probe_ie2_v14'
