...
Uso: python work/ie2/shared/capas/historial/teclado/v18_teclado/apply.py
"""
...
sys.path.insert(0, str(ROOT / 'work/ie1/capas/graficos/graficos_nds'))
...
NAME_B = ROOT / 'work/ie2/shared/capas/historial/graficos/v12_graficos/extra/inazuma2/data_iz/a_menu/name_b.arc'
