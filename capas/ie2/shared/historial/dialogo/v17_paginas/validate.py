...
Uso: python -X utf8 work/ie2/shared/capas/historial/dialogo/v17_paginas/validate.py  -> validacion.json
"""
...
def main():
    ...
    # vídeos
    inf = json.loads((W / 'ie2/shared/capas/media/subtitulos/informe.json').read_text(encoding='utf-8'))
