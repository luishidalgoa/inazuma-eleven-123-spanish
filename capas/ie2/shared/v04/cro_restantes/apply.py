...
work/ie1/capas/v90/cro_restantes/apply.py, que escribe aquí romfs/cro/ina_main2.cro, extra/font/*.bcfnt
(idénticas a las de IE1 v90), informe.json y previews/. Registro: work/ie1/capas/v90/cro_restantes/registro.json.
...
runpy.run_path(str(ROOT / 'work/ie1/capas/v90/cro_restantes/apply.py'), run_name='__main__')
