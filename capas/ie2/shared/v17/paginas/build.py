...
(ganan sobre todo lo que toque movie/), los moflex de ie2/shared/capas/v11/subtitulos/extra (34) y
ie2/tormenta_de_fuego/capas/v11/subtitulos/extra (op00).
romfs/: el de v16 tal cual (CRO parcheadas de v15/v16, SAD, voz del título).
No instala nada.
Uso: python -X utf8 work/ie2/shared/capas/v17/paginas/build.py
"""
...
SUBS = [W / 'ie2/shared/capas/v11/subtitulos/extra',
        W / 'ie2/tormenta_de_fuego/capas/v11/subtitulos/extra']
...
def main():
    ...
    rep['capas_v17'] = ['(temporal) eve/mch IE2 de ie2/shared/capas/v17/paginas'] + [str(s) for s in SUBS]
