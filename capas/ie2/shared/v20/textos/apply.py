...
Registro de bigramas: work/ie2/shared/capas/v08/nombres_compactos/registro.json (fuentes de la v18 = las
...
Uso: python -X utf8 work/ie2/shared/capas/v20/textos/apply.py   (después validate.py)
"""
...
V03 = ROOT / 'work/ie2/shared/capas/v03/textos'
...
def main():
    ...
    reg_out['descripcion'] = reg['descripcion'] + (
        ' IE2 v20 (work/ie2/shared/capas/v20/textos): casillas compactas del menú de campo (FONT12, clave U+E00A '
    ...
    informe.update(
        ...
        dibujo={'menu_campo': '0xbd1e8 -> 0x121a78, gestor [0x29b28c] = FONT12 (paso 15)',
                ...
                'nota': 'los gestores de fuente 0x29b284/88/8c/90 = FONT8/RUBI8/FONT12/FONT12T '
                        '(work/ie1/capas/v90/cro_restantes/explorar.py); el menú de campo NO usa FONT8'},
