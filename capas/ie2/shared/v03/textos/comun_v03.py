...
- Lectura: `Archivo` de la capa v02 (work/ie2/tormenta_de_fuego/capas/v02/dialogo/comun_ie2.py) y
  `abrir` (mmap) de IE1 v88.
- Transporte: `transportar` = dialogue_typography.encode_fullwidth (ancho completo cp932 + portadores).
- Bigramas: SOLO los códigos del registro de IE1 v89 (work/ie1/capas/v89/bigramas_ritmo/registro.json).
  ...
  work/ie2/shared/capas/v01/limites_cro/informe.json):
...
ROOT = HERE.parents[5]
V02 = ROOT / 'work/ie2/tormenta_de_fuego/capas/v02/dialogo'
for p in (V02, ROOT / 'work/ie1/capas/v88/bigramas_total', ROOT / 'tools/src', ROOT / 'tools'):
...
A89 = comun88.modulo('v89_bigramas_ritmo', ROOT / 'work/ie1/capas/v89/bigramas_ritmo/apply.py')
A88 = A89.A88
R = A89.R
F12, F8, F12T = A88.F12, A88.F8, A88.F12T
FUENTES = (F12, F8, F12T)
REGISTRO = ROOT / 'work/ie1/capas/v89/bigramas_ritmo/registro.json'
