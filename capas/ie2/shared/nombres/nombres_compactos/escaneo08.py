"""v08 · escaneo estricto de códigos candidatos (mismas reglas que work/ie1/capas/historial/fuentes/v88_bigramas_total/escaneo_kanji88.py),
...
ROOT = HERE.parents[5]
sys.path.insert(0, str(ROOT / 'work/ie1/capas/historial/fuentes/v88_bigramas_total'))
