...
ROOT = HERE.parents[5]
W = ROOT / 'work'
V88DIR = W / 'ie1/capas/historial/fuentes/v88_bigramas_total'
for p in (V88DIR, W / 'ie1/capas/fuentes/bigramas_ritmo'):
...
REG07 = W / 'ie2/shared/capas/media/media/registro.json'
FUENTE_ORIGEN = {F12: W / 'ie2/shared/capas/media/media/extra' / F12,
                 F8: W / 'ie1/capas/historial/menus_cro/v90_cro_restantes/extra' / F8,
                 F12T: W / 'ie1/capas/historial/menus_cro/v90_cro_restantes/extra' / F12T}
