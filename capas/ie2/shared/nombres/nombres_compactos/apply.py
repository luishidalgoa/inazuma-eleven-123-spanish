...
Uso: python -X utf8 work/ie2/shared/capas/nombres/nombres_compactos/apply.py
"""
...
INF88 = W / 'ie1/capas/historial/fuentes/v88_bigramas_total/informe.json'
TABLA_IE2 = W / 'ie2/tormenta_de_fuego/capas/rotulos_objetivos/rotulos/tabla.json'
INF_IE2 = W / 'ie2/tormenta_de_fuego/capas/rotulos_objetivos/rotulos/informe.json'
ESC_JP = HERE / 'escaneo_base_jp.json'
ESC_V05 = HERE / 'escaneo_v05.json'
LIT_V08 = HERE / 'escaneo_literales_v08.json'
V07 = W / 'ie2/shared/capas/media/media'
...
# copia de work/ie2/shared/capas/media/media/comun_media.GRAFICOS_V90 (mismo depósito que v07)
...
INF_NOM_IE2 = W / 'ie2/shared/capas/historial/nombres/v03_textos/nombres/informe.json'
...
def main():
    ...
    (HERE / 'cambios_registros.json').write_text(json.dumps(dict(
        nota='Cuerpos por registro (base probe_ie2_v05) para fusionar con otras capas que reescriben los '
             'mismos eventos completos (p. ej. work/ie1/capas/historial/dialogo/v91_nombres_oficiales). Contiene texto del juego: no publicar.',
        registros=por_registro), ensure_ascii=False, indent=1), encoding='utf-8')

    # ---- registro e informe ----------------------------------------------------------------------------
    reg_out = dict(reg)
    reg_out['version'] = 'ie2_v08_nombres_compactos'
    reg_out['descripcion'] = (reg['descripcion'] + ' IE2 v08 (work/ie2/shared/capas/nombres/nombres_compactos): '
