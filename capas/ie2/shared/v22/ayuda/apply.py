...
Uso: python -X utf8 work/ie2/shared/capas/v22/ayuda/apply.py
"""
...
def revertir_mastutorial(informe):
    ...
    destino.parent.mkdir(parents=True, exist_ok=True)
    destino.write_bytes(datos)
    informe.append(dict(ruta=K.MASTUTORIAL, clase='reversion', revierte='work/ie2/tormenta_de_fuego/capas/v21/tutorial',
