...
1. Voces: cada sound/sp/*.SAD de la NDS ES cuyo nombre existe (sin distinguir mayúsculas) en
   ...
   - propios de Fuego (comun_media.SOLO_FUEGO_SAD) -> work/ie2/tormenta_de_fuego/capas/media/media/romfs_mod/...
...
Uso: python -X utf8 work/ie2/shared/capas/media/media/apply.py
"""
...
def main():
    ...
    informe = dict(capa='work/ie2/shared/capas/media/media', issue=74,
                   fuego='work/ie2/tormenta_de_fuego/capas/media/media',
