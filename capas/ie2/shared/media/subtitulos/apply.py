...
Salida: extra/inazuma2/data_iz/movie/<n>.moflex (op00 en work/ie2/tormenta_de_fuego/capas/media/subtitulos),
...
def main():
    ...
    informe = dict(capa='work/ie2/shared/capas/media/subtitulos', fuego=str(S.SALIDA_FUEGO.relative_to(S.ROOT)),
