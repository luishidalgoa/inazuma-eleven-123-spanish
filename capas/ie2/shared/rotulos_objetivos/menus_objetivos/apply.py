...
Uso: python -X utf8 work/ie2/shared/capas/rotulos_objetivos/menus_objetivos/apply.py   (después validate.py)
"""
...
V20 = ROOT / 'work/ie2/shared/capas/historial/nombres/v20_textos'
...
def main():
    ...
    reg_out['descripcion'] = reg_doc['descripcion'] + (
        ' IE2 v22 (work/ie2/shared/capas/rotulos_objetivos/menus_objetivos): casillas de los menús de campo/Tácticas (FONT12, '
