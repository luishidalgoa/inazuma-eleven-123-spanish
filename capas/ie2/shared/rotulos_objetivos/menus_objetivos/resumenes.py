...
que NO se versiona: vive en work/ie2/shared/capas/rotulos_objetivos/menus_objetivos/resumenes.json con el formato
...
_DATOS = _RAIZ / 'work/ie2/shared/capas/rotulos_objetivos/menus_objetivos/resumenes.json'
