...
ROOT = HERE.parents[6]
W = ROOT / 'work'
G = W / 'ie2/shared/capas/historial/graficos/v03_graficos'
sys.path.insert(0, str(G))
import comun as K  # noqa: E402


SNAP = W / 'ie2/shared/capas/historial/graficos/v05_graficos_snapshot'
FONT = W / 'ie1/capas/historial/menus_cro/v90_cro_restantes/extra'
...
for n, src in (('ina_main1.cro', W / 'ie1/capas/historial/menus_cro/v90_cro_restantes/romfs/cro'),
               ('ina_main2.cro', W / 'ie2/shared/capas/menus_cro/cro_restantes/romfs/cro')):
