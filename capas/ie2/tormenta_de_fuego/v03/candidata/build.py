...
Mismo envoltorio que v02 (work/ie2/tormenta_de_fuego/capas/v02/dialogo/build.py): nucleo.construir.candidata
...
Capas de ficheros (la última gana; ninguna repite fichero, se comprueba):
  work/ie2/shared/capas/v03/textos/{nombres,tablas_a,tablas_b}/extra, extra_mch (mch reempaquetado)
...
M = K.M
TEXTOS = ROOT / 'work/ie2/shared/capas/v03/textos'
...
def main():
    ...
    rep['nota_ie2'] = ('events_mch = inazuma2/data_iz/script/eve.pk{h,b} (RUTA_MCH redirigida); mch de IE2 '
                       'reempaquetado en extra_mch (work/ie2/tormenta_de_fuego/capas/v03/candidata/build.py)')
