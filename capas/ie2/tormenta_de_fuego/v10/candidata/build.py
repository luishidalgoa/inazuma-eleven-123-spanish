...
Capas (la última gana; mismo envoltorio que v05, nucleo.construir.candidata, sin editar tools/):
 ...
 2. CRO IE1: ie1/capas/v93/cofres (v90 + cofres).   3. CRO IE2: ie2/shared/capas/v09/cofres (v04 + cofres).
...
V91 = W / 'ie1/capas/v91/nombres_oficiales'
V92 = W / 'ie1/capas/v92/redump_eu3ds'
V08 = W / 'ie2/shared/capas/v08/nombres_compactos'
CRO1 = W / 'ie1/capas/v93/cofres/romfs/cro/ina_main1.cro'
CRO2 = W / 'ie2/shared/capas/v09/cofres/romfs/cro/ina_main2.cro'
MEDIA = W / 'ie2/shared/capas/v07/media'
MEDIA_F = W / 'ie2/tormenta_de_fuego/capas/v07/media'
CAPAS = [W / 'ie2/shared/capas/v05/graficos_snapshot/extra',
         W / 'ie2/shared/capas/v06/graficos/extra',
         MEDIA / 'extra', MEDIA_F / 'extra',
         V08 / 'extra']
ROMFS = [W / 'ie1/legacy/volumen_1/ie1_media_mod/romfs',   # 70 SAD IE1 (14 siguen siendo estos)
         W / 'ie1/capas/v57/voces_eu/romfs',                # 56 SAD EU + 128 SED/SWD
