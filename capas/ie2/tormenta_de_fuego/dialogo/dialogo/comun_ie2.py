...
- ajuste: `comun82` de v84 (22 caracteres por línea, 3 líneas por página, sin cortar palabras) con el
  modelo del motor (`comun82.motor`); IE2 usa los mismos valores (work/ie2/shared/capas/historial/menus_cro/v01_limites_cro).
"""
...
K82 = _modulo('comun82_v84', ROOT / 'work/ie1/capas/historial/dialogo/v84_saltos_dialogo_total/comun82.py')
...
V01_EVENTOS = ROOT / 'work/ie2/tormenta_de_fuego/capas/historial/candidata/v01_sonda/events'
FUENTES_V01 = ROOT / 'work/ie2/shared/capas/fuentes/fuentes/extra'
NOMBRE_V01 = ROOT / 'work/ie2/shared/capas/historial/nombres/v01_sonda_nombre/extra'
