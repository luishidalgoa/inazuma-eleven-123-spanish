...
archive.fa: el de v18 con estas capas de ficheros (la última gana; no se solapan):
  1. ie2/shared/capas/v20/teclado/extra   (MMName.SPF_, MMProfd.SPF_)
  2. ie2/shared/capas/v20/textos/extra    (unitbase.dat, item.dat, FONT12/FONT8.bcfnt)
  3. ie2/shared/capas/v20/graficos/extra  (bocadillos, Valor, Límite, afinidades...)
  4. ie2/tormenta_de_fuego/capas/v21/tutorial/extra (MASTutorial.SPF_ de la NDS ES)
...
No instala nada.
Uso: python -X utf8 work/ie2/tormenta_de_fuego/capas/v21/candidata/build.py
"""
...
V20 = W / 'ie2/shared/capas/v20'
CAPAS = [V20 / 'teclado/extra', V20 / 'textos/extra', V20 / 'graficos/extra',
         W / 'ie2/tormenta_de_fuego/capas/v21/tutorial/extra']
CRO1 = V18 / 'romfs/cro/ina_main1.cro'
CRO2 = V20 / 'textos/romfs/cro/ina_main2.cro'
VOZ = V20 / 'voces/romfs_mod'
