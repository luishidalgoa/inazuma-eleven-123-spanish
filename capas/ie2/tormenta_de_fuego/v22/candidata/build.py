...
archive.fa: el de v21 con estas capas (no se solapan):
  1. ie2/shared/capas/v22/menus_objetivos: extra/font/FONT12.bcfnt y FONT8.bcfnt; eventos ie2/eve/*.ssd
  ...
  2. ie2/shared/capas/v22/ayuda/extra: 74 capturas de ayuda, a_menu/system_b.arc y MASTutorial.SPF_
     japonés (revierte v21/tutorial).
  3. ie2/shared/capas/v22/graficos_faltantes/extra: a_game/battle_start_b.arc.
...
No instala nada.
Uso: python -X utf8 work/ie2/tormenta_de_fuego/capas/v22/candidata/build.py
"""
...
V22 = W / 'ie2/shared/capas/v22'
MENUS = V22 / 'menus_objetivos'
EVE = MENUS / 'ie2/eve'
MCH = MENUS / 'ie2/mch'
CAPAS_FIJAS = [MENUS / 'extra', V22 / 'ayuda/extra', V22 / 'graficos_faltantes/extra']
...
C19 = _modulo('comun19_v22', W / 'ie2/shared/capas/v19/saltos37/comun19.py')
M = C19.M
